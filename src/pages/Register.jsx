                ...
                >
                    <Box
                        ...
                        sx={{
                            ...
                            // Aseguramos el centrado completo del Box
                            margin: '0 auto',
                        }}
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <Grid container spacing={3}>
                                ...
                                {/* === FILA 1: Nombre (50%) y Apellido (50%) === */}
                                
                                {/* Nombre: xs=12 (Móvil) y sm=6 (Escritorio/Tablet, 50% de ancho) */}
                                ...
                                {/* Apellido: xs=12 (Móvil) y sm=6 (Escritorio/Tablet, 50% de ancho) */}
                                ...
                                {/* === FILA 2: Email (100% - Fila completa) === */}
                                {/* Email: xs=12 (100% de ancho) */}
                                ...
                                {/* === FILA 3: Contraseña (50%) y Confirmar Contraseña (50%) === */}
 
                                
                                {/* Contraseña: xs=12 (Móvil) y sm=6 (Escritorio/Tablet, 50% de ancho) */}
                                ...
                                {/* Confirmar Contraseña: xs=12 (Móvil) y sm=6 (Escritorio/Tablet, 50% de ancho) */}
                                <Grid item xs={12} sm={6}>
                                ...
                                {/* === FILA 4: Teléfono (50%) y Tipo de Cuenta (50%) === */}
                    
             
                                {/* Teléfono: xs=12 (100% en móvil), sm=6 (50% en escritorio/tablet) */}
                                <Grid item xs={12} sm={6}>
                                    ...
                                    {/* Tipo de Cuenta (Select): xs=12 (100% en móvil), sm=6 (50% en escritorio/tablet) */}
                                ...
                                {/* === FILA 5: ReCAPTCHA (100% - Fila completa, CENTRADO) === */}
   
                  
                                <Grid item xs={12}>
                                {/* Ajuste para centrar el componente ReCAPTCHA */}
                            ...
                            {/* BOTÓN 2: VOLVER A INICIO (Añadido) */}
                            <Button
                                ...
                                disabled={loading}
                                sx={{
                                    mt: 0.5, // Pequeño margen superior
                                    py: { xs: 1, sm: 1.2 },
